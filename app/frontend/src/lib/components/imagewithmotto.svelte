<script>
    import ReadBook from '$lib/img/readbookeveryday.jpg';
</script>

<div class="position-relative">
    <img src={ReadBook} class="img-fluid" style="width: 100%" alt="Read book">
    <div class="position-absolute top-0 start-0 w-100 h-100 cover"></div>
